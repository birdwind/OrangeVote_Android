...
public abstract class AbstractBaseSubscriber<T extends ResponseBody, RS extends AbstractResponse, RD extends BaseResponse>
    extends DisposableSubscriber<T> implements BaseSubscriber<RD> {
    ...
    public AbstractBaseSubscriber(BaseView view, Class<RS> clazz) {
        this.view = view;
        this.clazz = clazz;
    }

    public AbstractBaseSubscriber(BaseView view, boolean isShowDialog) {
        this.view = view;
